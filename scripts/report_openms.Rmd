...
ggplot(plot_data, aes(x=date, y=cumsum(calls), fill=DevelopedBy)) + 
  geom_area(aes(colour=DevelopedBy, fill=DevelopedBy))
axis(1, at=(plot_data[,2])[seq(1,nrow(plot_data),length.out = 9)],
       labels = format((plot_data[,2])[seq(1,nrow(plot_data),length.out = 9)], "%b %Y") )
