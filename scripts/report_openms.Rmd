...
\begin{center}
```{r time_frame, results="markup"}
print(paste(min(global_logdata$date), "to", max(global_logdata$date))
```
\end{center}
...
|------------------------------------|------------------------------------|------------------------------------|------------------------------------|
|[![Github releases (by asset)](https://img.shields.io/github/downloads/OpenMS/OpenMS/latest/OpenMS-2.3.0-Darwin.dmg.svg)](https://github.com/OpenMS/OpenMS/releases/)|[![Github releases (by asset)](https://img.shields.io/github/downloads/OpenMS/OpenMS/latest/OpenMS-2.3.0-Linux.deb.svg)](https://github.com/OpenMS/OpenMS/releases/)|[![Github releases (by asset)](https://img.shields.io/github/downloads/OpenMS/OpenMS/latest/OpenMS-2.3.0-Win64.exe.svg)](https://github.com/OpenMS/OpenMS/releases/)|[![Github releases (by asset)](https://img.shields.io/github/downloads/OpenMS/OpenMS/latest/OpenMS-2.3.0-src.tar.gz.svg)](https://github.com/OpenMS/OpenMS/releases/)|
